        ...
        Row(
            ...
            IconButton(
                    ...
                    if (!isSyncing) {
                        coroutineScope.launch {
                            ...
                            try {
                                ...
                                // Show error toast
                                Toast.makeText(context, context.getString(R.string.sync_failed_message, e.message ?: ""), Toast.LENGTH_LONG).show()
                            } finally {
                                isSyncing = false
                            }
                        }
                ...
                if (isSyncing) {
                    ...
                    Icon(
                        painter = painterResource(R.drawable.sync),
                        contentDescription = stringResource(R.string.fetch_from_youtube_music),
