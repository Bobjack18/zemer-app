...
object YouTube {
    ...
    // Whether the current session is an anonymous login. Main has no anonymous-login
    // concept, so this defaults to false (treat everyone as a real login); podcast
    // code uses it only to gate server-side sync.
